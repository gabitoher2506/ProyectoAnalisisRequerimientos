from flask import Flask, render_template  # Eliminé los imports innecesarios

app = Flask(__name__)
# app.secret_key = 'f6d7d98e9a2b7f4a35f4b5e7d6a7c8e9'  # Comenté la clave secreta ya que no se necesita sin lógica
